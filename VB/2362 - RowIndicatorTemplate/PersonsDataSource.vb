...
Namespace _2362___RowIndicatorTemplate
	Public Class PersonsViewModel
		Private persons_Renamed As ObservableCollection(Of Person)

		Public Sub New()
			Dim Names As New List(Of String) (New String() {"Alex", "Effy", "Alice", "Tony", "Den", "John", "Donald", "Brian", "Andrew", "Lisa", "Matthew", "Robert", "Maria"})
